...
public class ClipBoardManager extends Activity {
	Button yes_btn,no_btn;
	
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_clipboardmanager);
		...
		yes_btn.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				editor.putBoolean("state_clipboard_speak",true);
				editor.commit();
		...
		no_btn.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				SharedPreferences settings = PreferenceManager.getDefaultSharedPreferences(getBaseContext());
				SharedPreferences.Editor editor = settings.edit();
				editor.putBoolean("state_clipboard_speak",false);
				editor.commit();
